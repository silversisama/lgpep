...
extern const u8 gText_HealingItems[];
extern const u8 gText_HeldItems[];
extern const u8 gText_MiscItems[];
...
extern const u8 gText_OakSpeech_YesNuzlockeHC[];
extern const u8 gText_OakSpeech_NuzlockeHC[];
extern const u8 gText_BallsCannotBeUsedDups[];
