...
#define FLAG_RANDOMIZER_WILD_MON                           0x0BA
#define FLAG_RANDOMIZER_FIELD_ITEMS                        0x0BB
...
// Unused?
#define FLAG_RECEIVED_BOX_LINK               0x300
...
#define FLAG_SYS_POKERIDE_JUMP                                      (SYS_FLAGS + 0xC3)
#define FLAG_SYS_POKERIDE_SURF                                      (SYS_FLAGS + 0xC4)
#define FLAG_SYS_POKERIDE_FLY                                       (SYS_FLAGS + 0xC5)
