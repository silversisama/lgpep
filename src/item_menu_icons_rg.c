...
static const union AnimCmd sAnim_Bag_OpenHealingItemsPocket[] = {
    ANIMCMD_FRAME(   0, 5),
...
static const union AnimCmd sAnim_Bag_OpenMiscItemsPocket[] = {
    ANIMCMD_FRAME(   0, 5),
    ANIMCMD_FRAME(0x80, 0),
    ANIMCMD_END
};
...
static const union AnimCmd *const sAnims_Bag[] = {
    [FRLG_POCKET_HEALING_ITEMS]      = sAnim_Bag_OpenHealingItemsPocket,
    [FRLG_POCKET_HELD_ITEMS]   = sAnim_Bag_OpenHeldItemsPocket,
    [FRLG_POCKET_MISC_ITEMS]  = sAnim_Bag_OpenMiscItemsPocket,
